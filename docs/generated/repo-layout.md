...
Workspace members: `crates/*` → 10 crates.
...
Tauri-free (9): `cubical-ast`, `cubical-cli`, `cubical-core`, `cubical-engine`, `cubical-index`, `cubical-ipc`, `cubical-query`, `cubical-search`, `cubical-sync`.
